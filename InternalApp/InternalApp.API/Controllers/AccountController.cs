// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AccountController.cs" company="EPAM Systems India">
//   Copyright 2015
// </copyright>
// <summary>
...
namespace InternalApp.API.Controllers
{
    using System;
    ...
    using InternalApp.API.Providers;
    using InternalApp.API.Results;
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error)
        {
            if (error != null)
            {
